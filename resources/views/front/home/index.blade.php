        ...
        <div class="row">
            <div class="col-md-6 p-b-30 m-lr-auto">
                ...
                <div class="block1 wrap-pic-w">
                    <img src="{{asset('fronty')}}/images/banner-04.jpg" alt="IMG-BANNER">
            ...
            <div class="col-md-6 p-b-30 m-lr-auto">
                <!-- Block1 -->
                <div class="block1 wrap-pic-w">
                    <img src="{{asset('fronty')}}/images/banner-05.jpg" alt="IMG-BANNER">
            ...
            <div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
                <!-- Block1 -->
                <div class="block1 wrap-pic-w">
                    <img src="{{asset('fronty')}}/images/banner-07.jpg" alt="IMG-BANNER">
            ...
            <div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
                <!-- Block1 -->
                <div class="block1 wrap-pic-w">
                    <img src="{{asset('fronty')}}/images/banner-08.jpg" alt="IMG-BANNER">
            ...
            <div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
                <!-- Block1 -->
                <div class="block1 wrap-pic-w">
                    <img src="{{asset('fronty')}}/images/banner-09.jpg" alt="IMG-BANNER">
